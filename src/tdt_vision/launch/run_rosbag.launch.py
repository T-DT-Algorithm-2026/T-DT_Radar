...
def generate_launch_description():
    ...
    def get_rosbag_player_node(package, plugin):
        return ComposableNode(
            ...
            parameters=[{
                ...
                'storage': {
                    'uri': '/home/mozihe/T-DT_Radar/ros2bag/适应性训练第一把/merged_bag_0.db3',
                    'storage_id': 'sqlite3'
                }
            }],
    ...
    ros_bag_player_node = get_rosbag_player_node('rosbag2_transport', 'rosbag2_transport::Player')
